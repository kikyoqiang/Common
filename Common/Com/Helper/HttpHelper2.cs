            ...
            try
            {
                ...
                using (response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    using (MemoryStream _stream = new MemoryStream())
                    {
                        ...
                        {
                            //开始读取流并设置编码方式
                            new GZipStream(response.GetResponseStream(), CompressionMode.Decompress).CopyStream(_stream, 10240);
                        }
                        else
                        {
                            //开始读取流并设置编码方式
                            response.GetResponseStream().CopyStream(_stream, 10240);
                        }
                        //获取Byte
                    ...
                    if (ResponseByte != null & ResponseByte.Length > 0)
                    {
                        ...
                        else
                        {
                            ...
                            result.Html = encoding.GetString(ResponseByte);//得到返回的HTML
                        }
